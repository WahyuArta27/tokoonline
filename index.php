...
<head>
  ...
  <style>
    /* Menambahkan gambar background ke seluruh halaman */
    body {
      background-image: url("assets/img/pcbackground.jpg");
    ...
    <div class="header-content">
      <div class="row">
        <div class="col-md-5 my-auto mx-auto" data-aos="fade-right">
          <h2>Toko Komputer</h2>
          <p>
            Menyediakan semua kebutuhan komputer anda!
          </p>
        ...
        <div class="col-md-6 my-auto mx-auto" data-aos="zoom-in">
          <div class="d-flex justify-content-center align-items-center flex-column">
            <!-- Gambar banner diubah menjadi pcgaming.jpg -->
            <img src="assets/img/pcgaming.jpg" alt="banner" class="my-5">
          </div>
        </div>
      </div>
    </div>
